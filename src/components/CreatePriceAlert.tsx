  ...
  return (
    <div className="min-h-screen bg-bg-white relative max-w-[438px] mx-auto">
      ...
      <div className="relative z-10 flex flex-col">
        {/* Header */}
        <div className="bg-bg-white/95 backdrop-blur-sm sticky top-0 z-20 pt-1.5">
          ...
          <div className="bg-bg-white border border-gray-stroke rounded-card p-4.5">
            ...
            <div className="px-13.5 py-9 rounded-card">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="flex items-center gap-[7px] hover:bg-gray-50 px-2 py-1 rounded-lg transition-colors"
                >
            ...
            <div className="bg-bg-gray px-13.5 py-9 rounded-card">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="flex items-center gap-[7px] hover:bg-white/50 px-2 py-1 rounded-lg transition-colors">
